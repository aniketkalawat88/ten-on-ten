...
const AboutCompo = () => {
  ...
  return (
    <div className="relative">
        <div className="md:h-[26.5vw] w-full bg-primary-main/50 absolute top-36 -z-10" />
        <div className="max-w-7xl mx-auto xl:p-0 p-6">
            <div className="flex flex-col-reverse lg:flex-row justify-between md:gap-8 sm:gap-6 gap-4 shadow-[0px_8px_16px_0px_rgba(0,0,0,0.16)] md:p-6 p-4 md:my-14 sm:my-6 my-4 rounded-md bg-white">
                ...
                <button onClick={PopupOpen} className="bg-heading-main text-primary-main hover:bg-heading-main py-2.5 px-4 rounded-full text-base font-bold transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg md:w-1/3 md:my-12 my-6" >Get Free consulation</button>
                </div>
