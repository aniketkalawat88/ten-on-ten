...
const WhyUs = () => {
  return (
    <div className="bg-primary-main/30 md:mt-32 md:pb-20 md:mb-20">
        ...
        <div className="flex justify-center items-center md:mt-4 sm:mt-4 mt-4">
            <Link href="/about-us" className="bg-heading-main text-lg text-primary-main flex justify-center items-center w-56 py-2.5 rounded-full">View all</Link>
        </div>
