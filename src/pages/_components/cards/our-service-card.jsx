...
const OurServiceCard = () => {
  ...
  <div className="flipper">
      <div className="front p-6 shadow shadow-primary-main/50 rounded-xl h-96 w-full">
    ...
    <div className="back">
    <div className="p-6 shadow shadow-primary-main/50 rounded-xl text-center h-96 overflow-hidden">
